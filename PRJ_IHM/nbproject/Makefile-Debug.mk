...
LDLIBSOPTIONS=../PRJ_IHM/resource.res -lwsock32 -luser32

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prj_ihm.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prj_ihm.exe: ../PRJ_IHM/resource.res
...
${OBJECTDIR}/_ext/1275822200/C_CLIENT.o: ../PRJ_IHM/C_CLIENT.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275822200/C_CLIENT.o ../PRJ_IHM/C_CLIENT.cpp

${OBJECTDIR}/_ext/1275822200/C_INFO.o: ../PRJ_IHM/C_INFO.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1275822200
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275822200/C_INFO.o ../PRJ_IHM/C_INFO.cpp

${OBJECTDIR}/_ext/1275822200/C_MUTEX.o: ../PRJ_IHM/C_MUTEX.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1275822200
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275822200/C_MUTEX.o ../PRJ_IHM/C_MUTEX.cpp

${OBJECTDIR}/_ext/1275822200/C_SERVEUR.o: ../PRJ_IHM/C_SERVEUR.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1275822200
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275822200/C_SERVEUR.o ../PRJ_IHM/C_SERVEUR.cpp

${OBJECTDIR}/_ext/1275822200/C_THREAD.o: ../PRJ_IHM/C_THREAD.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1275822200
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275822200/C_THREAD.o ../PRJ_IHM/C_THREAD.cpp

${OBJECTDIR}/PRJ_IHM.o: PRJ_IHM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PRJ_IHM.o PRJ_IHM.cpp
